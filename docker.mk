...
## ini-phpcs	:	Initialize PHPCS with Drupal config.
.PHONY: ini-phpcs
ini-phpcs:
	./vendor/bin/phpcs --config-set installed_paths vendor/drupal/coder/coder_sniffer

## phpcs		:	Sniff custom code with PHPCS.
.PHONY: phpcs
phpcs:
	./vendor/bin/phpcs --colors --report=full,summary --standard=Drupal,DrupalPractice --extensions=php,module,inc,install,test,profile,theme,css,info,yml --ignore=node_modules,vendor web/modules/custom

## phpcs-fix	:	Fix custom code with PHPCS.
.PHONY: phpcs-fix
phpcs-fix:
	./vendor/bin/phpcbf --colors --standard=Drupal,DrupalPractice --extensions=php,module,inc,install,test,profile,theme,css,info,yml --ignore=node_modules,vendor web/modules/custom
